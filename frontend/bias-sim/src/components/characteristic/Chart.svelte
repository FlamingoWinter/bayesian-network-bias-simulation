...
>
	<CharacteristicRectangle
		width={rectWidth}
		height={rectHeight}
		expanded={expanded && !disableInteraction}
		nodeId={node.id}
		{heightMultiplier}
		{network}
		{scoreAndApplication}
	...
	<CharacteristicTitle nodeId={node.id} {rectHeight} />
	...
	>
		{#if !disableInteraction}
			{#if !expanded}
				<ExpandButton {isHovered} callbackFunction={toggleExpand} />
			{:else}
