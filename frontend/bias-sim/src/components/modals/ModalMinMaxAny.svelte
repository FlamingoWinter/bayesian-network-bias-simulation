...
<div class="flex flex-grow flex-row items-center justify-start gap-10">
	<div class="flex flex-row items-center justify-start gap-4">
		<h3 class="text-md font-bold">Min:</h3>
		<input
			class="w-[6rem] p-2 rounded-container-token {minError
	...
	<div class="flex flex-row items-center justify-start gap-4">
		...
		<input
			class=" w-[6rem] p-2 rounded-container-token {maxError
				? 'variant-ringed-error'
				: 'variant-ringed'}"
			type="number"
			placeholder="Max..."
