...
class OptimiseForFPREquality(Mitigation):
    ...
    def calculate_fpr_variance(self,
    ...
    def extract_hiring_proportions_from_training_and_holdout(self, score_train: pd.Series, groups_train: pd.Series,
        ...
        self.proportion_hireds = self.get_proportions_to_minimise_loss(
            total_proportion_hired, score_holdout, predicted_holdout, groups_holdout, self.calculate_fpr_variance)
